...
public class ServerConfigurationFactory {
    ...
    public static class DataSources {
        public static final MysqlDataSource INSTANCE_dsMySQL_Duckairlines = createdsMySQL_Duckairlines();

        private static MysqlDataSource createdsMySQL_Duckairlines() {
            MysqlDataSource dsMySQL_Duckairlines = new MysqlDataSource();

            dsMySQL_Duckairlines.setURL(props.getProperty("dsMySQL_Duckairlines.jdbc.url"));
            dsMySQL_Duckairlines.setUser(props.getProperty("dsMySQL_Duckairlines.jdbc.username"));
            dsMySQL_Duckairlines.setPassword(props.getProperty("dsMySQL_Duckairlines.jdbc.password"));

            return dsMySQL_Duckairlines;
        }
    }
    ...
    public static IgniteConfiguration createConfiguration() throws Exception {
        ...
        ipFinder.setAddresses(Arrays.asList("192.168.100.106:47500..47510"));
    ...
    public static CacheConfiguration cacheAircraftCache() throws Exception {
        ...
        cacheStoreFactory.setDataSourceFactory(new Factory<DataSource>() {
            ...
            @Override public DataSource create() {
                return DataSources.INSTANCE_dsMySQL_Duckairlines;
            };
        });
        ...
        qryEntity.setValueType("com.kensbunker.duckairlines.model.Aircraft");
    ...
    private static JdbcType jdbcTypeAircraft(String cacheName) {
        ...
        type.setValueType("com.kensbunker.duckairlines.model.Aircraft");
    ...
    public static CacheConfiguration cacheAirportsCache() throws Exception {
        ...
        qryEntity.setKeyType("java.lang.Integer");
        qryEntity.setValueType("com.kensbunker.duckairlines.model.Airports");
    ...
    private static JdbcType jdbcTypeAirports(String cacheName) {
        ...
        type.setCacheName(cacheName);
        type.setKeyType(Integer.class);
        type.setValueType("com.kensbunker.duckairlines.model.Airports");
        type.setDatabaseSchema("duckairlines");
    ...
    public static CacheConfiguration cacheCrewCache() throws Exception {
        ...
        qryEntity.setValueType("com.kensbunker.duckairlines.model.Crew");
    ...
    private static JdbcType jdbcTypeCrew(String cacheName) {
        ...
        type.setValueType("com.kensbunker.duckairlines.model.Crew");
        type.setDatabaseSchema("duckairlines");
    ...
    public static CacheConfiguration cacheCustomersCache() throws Exception {
        ...
        qryEntity.setKeyType("java.lang.String");
        qryEntity.setValueType("com.kensbunker.duckairlines.model.Customers");
        qryEntity.setKeyFieldName("id");
    ...
    private static JdbcType jdbcTypeCustomers(String cacheName) {
        ...
        type.setCacheName(cacheName);
        type.setKeyType(String.class);
        type.setValueType("com.kensbunker.duckairlines.model.Customers");
        type.setDatabaseSchema("duckairlines");
    ...
    public static CacheConfiguration cacheFixCache() throws Exception {
        ...
        qryEntity.setKeyType("java.lang.Integer");
        qryEntity.setValueType("com.kensbunker.duckairlines.model.Fix");
        qryEntity.setKeyFieldName("id");
    ...
    private static JdbcType jdbcTypeFix(String cacheName) {
        ...
        type.setCacheName(cacheName);
        type.setKeyType(Integer.class);
        type.setValueType("com.kensbunker.duckairlines.model.Fix");
        type.setDatabaseSchema("duckairlines");
    ...
    public static CacheConfiguration cacheFleetCache() throws Exception {
        ...
        qryEntity.setKeyType("java.lang.String");
        qryEntity.setValueType("com.kensbunker.duckairlines.model.Fleet");
    ...
    private static JdbcType jdbcTypeFleet(String cacheName) {
        ...
        type.setCacheName(cacheName);
        type.setKeyType(String.class);
        type.setValueType("com.kensbunker.duckairlines.model.Fleet");
        type.setDatabaseSchema("duckairlines");
    ...
    public static CacheConfiguration cacheFlightPlansCache() throws Exception {
        ...
        qryEntity.setKeyType("java.lang.String");
        qryEntity.setValueType("com.kensbunker.duckairlines.model.FlightPlans");
    ...
    private static JdbcType jdbcTypeFlightPlans(String cacheName) {
        ...
        type.setCacheName(cacheName);
        type.setKeyType(String.class);
        type.setValueType("com.kensbunker.duckairlines.model.FlightPlans");
        type.setDatabaseSchema("duckairlines");
    ...
    public static CacheConfiguration cacheFlightsCache() throws Exception {
        ...
        qryEntity.setKeyType("java.lang.String");
        qryEntity.setValueType("com.kensbunker.duckairlines.model.Flights");
    ...
    private static JdbcType jdbcTypeFlights(String cacheName) {
        ...
        type.setCacheName(cacheName);
        type.setKeyType(String.class);
        type.setValueType("com.kensbunker.duckairlines.model.Flights");
        type.setDatabaseSchema("duckairlines");
    ...
    public static CacheConfiguration cacheFrequentFlyerCache() throws Exception {
        ...
        qryEntity.setKeyType("java.lang.String");
        qryEntity.setValueType("com.kensbunker.duckairlines.model.FrequentFlyer");
    ...
    private static JdbcType jdbcTypeFrequentFlyer(String cacheName) {
        ...
        type.setCacheName(cacheName);
        type.setKeyType(String.class);
        type.setValueType("com.kensbunker.duckairlines.model.FrequentFlyer");
        type.setDatabaseSchema("duckairlines");
    ...
    public static CacheConfiguration cacheNavaidCache() throws Exception {
        ...
        qryEntity.setKeyType("java.lang.Integer");
        qryEntity.setValueType("com.kensbunker.duckairlines.model.Navaid");
        qryEntity.setKeyFieldName("id");
    ...
    private static JdbcType jdbcTypeNavaid(String cacheName) {
        ...
        type.setCacheName(cacheName);
        type.setKeyType(Integer.class);
        type.setValueType("com.kensbunker.duckairlines.model.Navaid");
        type.setDatabaseSchema("duckairlines");
    ...
    public static CacheConfiguration cachePilotLogsCache() throws Exception {
        ...
        qryEntity.setKeyType("java.lang.String");
        qryEntity.setValueType("com.kensbunker.duckairlines.model.PilotLogs");
    ...
    private static JdbcType jdbcTypePilotLogs(String cacheName) {
        ...
        type.setCacheName(cacheName);
        type.setKeyType(String.class);
        type.setValueType("com.kensbunker.duckairlines.model.PilotLogs");
        type.setDatabaseSchema("duckairlines");
    ...
    public static CacheConfiguration cacheRouteMetadataCache() throws Exception {
        ...
        qryEntity.setKeyType("java.lang.Integer");
        qryEntity.setValueType("com.kensbunker.duckairlines.model.RouteMetadata");
    ...
    private static JdbcType jdbcTypeRouteMetadata(String cacheName) {
        ...
        type.setCacheName(cacheName);
        type.setKeyType(Integer.class);
        type.setValueType("com.kensbunker.duckairlines.model.RouteMetadata");
        type.setDatabaseSchema("duckairlines");
    ...
    public static CacheConfiguration cacheRouteSegmentsCache() throws Exception {
        ...
        qryEntity.setKeyType("java.lang.Integer");
        qryEntity.setValueType("com.kensbunker.duckairlines.model.RouteSegments");
    ...
    private static JdbcType jdbcTypeRouteSegments(String cacheName) {
        ...
        type.setCacheName(cacheName);
        type.setKeyType(Integer.class);
        type.setValueType("com.kensbunker.duckairlines.model.RouteSegments");
        type.setDatabaseSchema("duckairlines");
    ...
    public static CacheConfiguration cacheRunwayCache() throws Exception {
        ...
        qryEntity.setKeyType("java.lang.Integer");
        qryEntity.setValueType("com.kensbunker.duckairlines.model.Runway");
        qryEntity.setKeyFieldName("id");
    ...
    private static JdbcType jdbcTypeRunway(String cacheName) {
        ...
        type.setCacheName(cacheName);
        type.setKeyType(Integer.class);
        type.setValueType("com.kensbunker.duckairlines.model.Runway");
        type.setDatabaseSchema("duckairlines");
    ...
    public static CacheConfiguration cacheTelemetryCache() throws Exception {
        ...
        qryEntity.setKeyType("java.lang.String");
        qryEntity.setValueType("com.kensbunker.duckairlines.model.Telemetry");
        qryEntity.setKeyFieldName("rowId");
    ...
    private static JdbcType jdbcTypeTelemetry(String cacheName) {
        ...
        type.setCacheName(cacheName);
        type.setKeyType(String.class);
        type.setValueType("com.kensbunker.duckairlines.model.Telemetry");
        type.setDatabaseSchema("duckairlines");
    ...
    public static CacheConfiguration cacheWindsCache() throws Exception {
        ...
        qryEntity.setKeyType("java.lang.Integer");
        qryEntity.setValueType("com.kensbunker.duckairlines.model.Winds");
    ...
    private static JdbcType jdbcTypeWinds(String cacheName) {
        ...
        type.setCacheName(cacheName);
        type.setKeyType(Integer.class);
        type.setValueType("com.kensbunker.duckairlines.model.Winds");
        type.setDatabaseSchema("duckairlines");
